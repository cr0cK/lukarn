...
export const fr: Messages = {
  ...
  'shares.edit': 'Modifier',
  'shares.editTitle': 'Modifier le lien de partage',
  'shares.save': 'Enregistrer',
  'shares.updateFailed': 'Impossible de mettre à jour ce lien.',
  'shares.share': 'Partager',
  'shares.shareAlbum': 'Partager l’album',
  'shares.sharePhoto': 'Partager la photo',
  'shares.shareDialogIntro': 'Générer un lien direct pour quelqu’un sans compte.',
  'shares.expiry7Days': '7 jours',
